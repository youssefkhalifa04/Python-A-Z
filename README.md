...
1. Read the demonstration files first.
2. Try the exercises without opening the correction.
3. Compare your work with the correction only after making an attempt.
4. Use the annex files when you need a quick reference.
